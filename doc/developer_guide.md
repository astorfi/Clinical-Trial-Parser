...
`$GOPATH/src/github.com/facebookresearch/Clinical-Trial-Parser` - Add the following lines to the bash profile: `export GOROOT=/usr/lib/go`, `export GOPATH=$HOME/go`, and `export GOBIN=$HOME/go/bin`.
